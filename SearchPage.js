...
_handleResponse(response) {
  ...
  if (response.application_response_code.substr(0, 1) === '1') {
    ...
    this.props.navigator.push({ title: 'Results', component: SearchResults, props: {listings: response.listings}}); //, component: SearchResults, passProps: {listings: response.listings});
